...
namespace ApiDemo.ApiService
{
    ...
    public class UserAccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register([FromBody] TD_Register model)
        {
            ...
            postData += "&username=" + UtilityHelper.ConstTokenPrefix.MobilePassword + model.Mobile;
        ...
        [HttpPost]
        [Route("logout")]
        public async Task<IHttpActionResult> Logout([FromBody] TD_Register model)
        {
        ...
        public async Task<IHttpActionResult> ProfileDetail([FromBody] TD_Register model)
        {
            throw new NotImplementedException();
        }
